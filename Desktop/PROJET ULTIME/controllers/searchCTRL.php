...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 try {
  ...
  // se connecter à la base de donneé
    $pdo_options[PDO::ATTR_ERRMODE] = PDO::ERRMODE_EXCEPTION;
  $bdd= new PDO('mysql:host='.$host.';dbname='.$basededonnee,$user,$password);
   
   
   
  //afficher les regions
 
 echo'<form name=\'region1\' method=\'POST\' action=\'rechercher.php\'>
          <select name=\'region\' onChange=\'submit()\'>';
    
               $res1=$bdd->query("SELECT DEPARTEMENT,DESIGNATION FROM departement");
                     while($result1=$res1->fetch())
                         {
                        echo "<option value=\"$result1[DEPARTEMENT]\">".$result1['DESIGNATION']."</option>";
